    ...
    Sandbox.unboxed_run(Repo, fn ->
      ...
      try do
        ...
        try do
          ...
          assert_receive {:stop_level_locked, ^locker}
          ...
          assert_receive {:apply_backend, ^apply_task, backend_pid}
          assert_receive {:serializable_attempt, ^apply_task}
          assert_postgres_lock_wait!(backend_pid)

          send(locker, :release_stop_level)
          assert_receive {:DOWN, ^locker_ref, :process, ^locker, :normal}
          ...
          assert_receive {:DOWN, ^apply_ref, :process, ^apply_task, :normal}
