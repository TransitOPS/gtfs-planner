defmodule GtfsPlannerWeb.UserAcceptInviteLive do
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        Set your password
        <:subtitle>Create a password to activate your account</:subtitle>
      </.header>
      ...
      >
        ...
        <:actions>
          <.button phx-disable-with="Setting password..." class="w-full">
  ...
  def handle_event("accept_invite", %{"user" => user_params}, socket) do
    ...
    case Accounts.accept_invite_set_password(socket.assigns.token, %{
           "password" => password,
