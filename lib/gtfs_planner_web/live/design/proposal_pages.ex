defmodule GtfsPlannerWeb.Design.ProposalPages do
  ...
  the service-day clock, tri-state accessibility, sequence, and diffs.
  """
  def transit(assigns) do
    ...
    <section id="ds-page-transit" class="max-w-4xl">
      ...
      <p class="mt-1 text-sm text-base-content/60">
        ...
        rows to 60% opacity, and a row you can act on must stay readable.
      </p>
      <div id="ds-diff-demo" class="mt-3 overflow-x-auto border border-base-300 p-4">
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-base-300">
            <tr>
              <td class="py-2 pr-4 font-medium text-success">+ Added</td>
              <td class="py-2 pr-4">Stop · Elm Street Station</td>
              <td class="py-2 font-mono text-xs text-base-content/70">stop_8841</td>
            </tr>
            <tr>
              <td class="py-2 pr-4 font-medium text-error">− Removed</td>
              <td class="py-2 pr-4">Stop · Old Depot</td>
              <td class="py-2 font-mono text-xs text-base-content/70">stop_1203</td>
            </tr>
            <tr>
              <td class="py-2 pr-4 font-medium">~ Changed</td>
              <td class="py-2 pr-4">Stop · Harbor Terminal</td>
              <td class="py-2 font-mono text-xs text-base-content/70">
                stop_lat: 47.60432 → 47.60455
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <p class="mt-3">
        <code class="ds-code-caption font-mono text-xs text-base-content/70">
          changed is neutral on purpose — change is the normal case in a diff review, not a warning
        </code>
      </p>
