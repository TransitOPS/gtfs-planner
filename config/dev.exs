...
config :gtfs_planner, GtfsPlannerWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:gtfs_planner, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:gtfs_planner, ~w(--watch)]}
  ]
...
config :gtfs_planner, GtfsPlannerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/gtfs_planner_web/router\.ex$",
      ~r"lib/gtfs_planner_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
...
config :gtfs_planner, :geoapify_api_key, "232508a26e0a4b85a0a97afcad8b958b"
